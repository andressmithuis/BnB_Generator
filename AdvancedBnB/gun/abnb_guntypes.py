...
class Rifle(Guntype):
    ...
    def get_basestats(tier):
        table = {
            ...
            4: {'hit_dice': Dice.from_string('1d8'), 'crit_dice': Dice.from_string('1d10'), 'hits_crits': {'glance': {'hits': 2, 'crits': 1}, 'solid': {'hits': 3, 'crits': 1}, 'penetrate': {'hits': 2, 'crits': 2}}, 'range': 6, 'mag_size': 5},
