...
class trait_do_no_harm(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_burst(-1)])
...
class trait_medic(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_medic()])
...
class trait_vampire(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_vampire()])
...
class trait_high_quality(WeaponTrait):
    ...
    def load_modifiers(self):
        ...
        self.attach_modifiers(new_properties)
...
class trait_non_elemental(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_non_elemental()])
...
class trait_tacticool(WeaponTrait):
    ...
    def load_modifiers(self):
        ...
        self.attach_modifiers(self.tacticool[equipment.rarity])
...
class trait_gun_shield(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_gun_shield()])
...
class trait_cumbersome(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_mag_size(-1)])
...
# Maliwan - Primary
class trait_maliwan_elemental(WeaponTrait):
    name = 'Elemental'
...
class trait_explosions(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_splash_range(1)])
...
class trait_concussive(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_knock_back(25)])
...
class trait_charge(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_charge()])
...
class trait_drain(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_drain()])
...
class trait_extended_mags(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_mag_size(2)])
...
class trait_grenade_launcher(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_grenade_launcher()])
...
class trait_taser(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_taser()])
...
class trait_dart(WeaponTrait):
    ...
    def load_modifiers(self):
        ...
        new_modifier.situational = True
        self.attach_modifiers([mod_range(2), new_modifier])
...
class trait_plasma_caster(WeaponTrait):
    ...
    def load_modifiers(self):
        self.attach_modifiers([mod_range(1), mod_burst(2)])
